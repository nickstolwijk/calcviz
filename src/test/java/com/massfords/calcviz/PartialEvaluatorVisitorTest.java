 ...
 *         Date: 3/1/12
 */
public class PartialEvaluatorVisitorTest extends Assert {

    private final PartialEvaluatorVisitor pev = new PartialEvaluatorVisitor();

    @Test
    public void graphWithVariable() throws Exception {
        // (4*2) + (x / (4-2))
        Add add = new Add()
                .withLeft(
    ...
    private Exp partiallyEvaluate(Exp exp) throws CalcException {
        exp.accept(pev);
